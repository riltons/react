      ...
      <div className="grid grid-cols-3 h-16">
        <button
          ...
          className={`flex flex-col items-center justify-center ${
            currentPath.includes('/communities') ? 'text-indigo-600' : 'text-gray-600'
          }`}
        >
          <svg
            className="w-6 h-6"
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center ${
            currentPath === '/players' ? 'text-indigo-600' : 'text-gray-600'
          }`}
        >
          <svg
            className="w-6 h-6"
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center ${
            currentPath === '/profile' ? 'text-indigo-600' : 'text-gray-600'
          }`}
        >
          <svg
            className="w-6 h-6"
